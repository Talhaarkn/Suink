...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      const Context = ((_a5 = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a5[index2]) || BaseContext;
      const value = React2.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime.jsx)(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
...
function createFocusScopesStack() {
  ...
  return {
    ...
    remove(focusScope) {
      var _a5;
      stack = arrayRemove(stack, focusScope);
      (_a5 = stack[0]) == null ? void 0 : _a5.resume();
    }
  };
}
...
var Portal = React13.forwardRef((props, forwardedRef) => {
  ...
  const container8 = containerProp || mounted && ((_a5 = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a5.body);
...
var RemoveScrollBar = function(_a5) {
  var noRelative = _a5.noRelative, noImportant = _a5.noImportant, _b4 = _a5.gapMode, gapMode = _b4 === void 0 ? "margin" : _b4;
  useLockAttribute();
...
function fromBase64(base64String4) {
  return Uint8Array.from(atob(base64String4), (char) => char.charCodeAt(0));
}
var CHUNK_SIZE = 8192;
...
function chunk(array2, size4) {
  return Array.from({ length: Math.ceil(array2.length / size4) }, (_, i) => {
    return array2.slice(i * size4, (i + 1) * size4);
  });
}
...
function transactionDataFromV1(data) {
  ...
  return parse(TransactionData3, {
    ...
    gasData: {
      ...
      price: ((_b4 = data.gasConfig.price) == null ? void 0 : _b4.toString()) ?? null,
...
var TransactionDataBuilder = class _TransactionDataBuilder {
  ...
  static restore(data) {
    if (data.version === 2) {
      return new _TransactionDataBuilder(parse(TransactionData3, data));
    } else {
      return new _TransactionDataBuilder(parse(TransactionData3, transactionDataFromV1(data)));
    }
  }
  /**
...
var _Transaction = class _Transaction2 {
  constructor() {
    ...
    this.object = createObjectMethods(
      (value) => {
        ...
        if (((_a5 = inserted == null ? void 0 : inserted.Object) == null ? void 0 : _a5.SharedObject) && typeof value === "object" && ((_b4 = value.Object) == null ? void 0 : _b4.SharedObject)) {
  ...
  static fromKind(serialized) {
    ...
    __privateSet4(tx, _inputSection, __privateGet4(tx, _data).inputs);
    __privateSet4(tx, _commandSection, __privateGet4(tx, _data).commands);
    return tx;
  }
  /**
  ...
  static from(transaction) {
    ...
    __privateSet4(newTransaction, _inputSection, __privateGet4(newTransaction, _data).inputs);
    __privateSet4(newTransaction, _commandSection, __privateGet4(newTransaction, _data).commands);
  ...
  setExpiration(expiration) {
    __privateGet4(this, _data).expiration = expiration ? parse(TransactionExpiration3, expiration) : null;
  }
  setGasPrice(price) {
  ...
  add(command) {
    if (typeof command === "function") {
      ...
      const txResult = createTransactionResult(__privateGet4(this, _data).commands.length - 1);
  ...
  async prepareForSerialization(options) {
    ...
    for (const intent of intents) {
      if ((_a5 = options.supportedIntents) == null ? void 0 : _a5.includes(intent)) {
        continue;
      }
...
runPlugins_fn = async function(plugins, options) {
  ...
  await createNext(0)();
  __privateSet4(this, _inputSection, __privateGet4(this, _data).inputs);
  __privateSet4(this, _commandSection, __privateGet4(this, _data).commands);
};
...
sortCommandsAndInputs_fn = function() {
  ...
  const filteredCommands = orderedCommands.filter(
    (cmd) => {
      var _a5;
      return ((_a5 = cmd.$Intent) == null ? void 0 : _a5.name) !== "AsyncTransactionThunk";
    }
  );
  ...
  function getOriginalIndex(index2) {
    ...
    if (((_a5 = command.$Intent) == null ? void 0 : _a5.name) === "AsyncTransactionThunk") {
...
getUsedObjects_fn = async function(transaction) {
  ...
  transaction.addSerializationPlugin(async (blockData, _options2, next) => {
    ...
    blockData.inputs.forEach((input) => {
      ...
      if ((_b4 = (_a5 = input.Object) == null ? void 0 : _a5.ImmOrOwnedObject) == null ? void 0 : _b4.objectId) {
...
execute_fn = async function(transaction, usedObjects, options, additionalSignatures = []) {
  ...
  try {
    ...
    const gasUsed = (_a5 = effects.V2) == null ? void 0 : _a5.gasUsed;
...
refillCoinPool_fn = async function() {
  ...
  (_a5 = effects.V2) == null ? void 0 : _a5.changedObjects.forEach(([id, { outputState }], i) => {
    var _a6;
    if (i === ((_a6 = effects.V2) == null ? void 0 : _a6.gasObjectIndex) || !outputState.ObjectWrite) {
      return;
    }
    __privateGet5(this, _coinPool).push({
      id,
...
var JOSEError = class extends Error {
  constructor(message, options) {
    ...
    (_a5 = Error.captureStackTrace) == null ? void 0 : _a5.call(Error, this, this.constructor);
  }
};
...
var DappPostMessageChannel = class {
  constructor({
    ...
    __privateAdd5(this, _DappPostMessageChannel_instances);
    __privateAdd5(this, _popup);
    __privateAdd5(this, _version, "1");
    __privateAdd5(this, _id);
    __privateAdd5(this, _hostOrigin);
    __privateAdd5(this, _hostPathname);
    __privateAdd5(this, _appName);
    __privateAdd5(this, _extraRequestOptions);
    __privateAdd5(this, _promise);
    __privateAdd5(this, _resolve);
    __privateAdd5(this, _reject);
    __privateAdd5(this, _interval, null);
    __privateAdd5(this, _isSendCalled2, false);
    __privateAdd5(this, _listener, (event) => {
      if (event.origin !== __privateGet6(this, _hostOrigin)) {
        return;
      }
      const { success, output } = safeParse(Response, event.data);
      if (!success || output.id !== __privateGet6(this, _id)) {
        return;
      }
      __privateMethod4(this, _DappPostMessageChannel_instances, cleanup_fn).call(this);
    ...
    __privateSet6(this, _id, crypto.randomUUID());
    __privateSet6(this, _popup, popup);
    __privateSet6(this, _hostOrigin, hostOrigin);
    __privateSet6(this, _hostPathname, hostPathname);
    __privateSet6(this, _appName, appName);
    const { promise, resolve, reject } = promiseWithResolvers();
    __privateSet6(this, _promise, promise);
    __privateSet6(this, _resolve, resolve);
    __privateSet6(this, _reject, reject);
    __privateSet6(this, _extraRequestOptions, extraRequestOptions);
    __privateSet6(this, _interval, setInterval(() => {
      try {
  ...
  send({
    ...
    if (__privateGet6(this, _isSendCalled2)) {
      throw new Error("send() can only be called once");
    }
    __privateSet6(this, _isSendCalled2, true);
    window.addEventListener("message", __privateGet6(this, _listener));
    const requestData = {
      version: __privateGet6(this, _version),
      requestId: __privateGet6(this, _id),
      appUrl: window.location.href.split("#")[0],
      appName: __privateGet6(this, _appName),
      payload: {
        type,
        ...data
      },
      metadata: getClientMetadata(),
      extraRequestOptions: __privateGet6(this, _extraRequestOptions)
    };
    const encodedRequestData = encodeURIComponent(btoa(JSON.stringify(requestData)));
    __privateGet6(this, _popup).location.assign(`${__privateGet6(this, _hostOrigin)}/${__privateGet6(this, _hostPathname)}#${encodedRequestData}`);
...
cleanup_fn = function() {
  if (__privateGet6(this, _interval)) {
    ...
    __privateSet6(this, _interval, null);
  }
...
var SlushWallet = class {
  constructor({
    ...
    __privateAdd6(this, _SlushWallet_instances);
    __privateAdd6(this, _id2);
    __privateAdd6(this, _events);
    __privateAdd6(this, _accounts);
    __privateAdd6(this, _origin);
    __privateAdd6(this, _walletName);
    __privateAdd6(this, _icon);
    __privateAdd6(this, _name);
    __privateAdd6(this, _signTransactionBlock, async ({
      transactionBlock,
      account,
      chain
    }) => {
      const data = await transactionBlock.toJSON();
      const popup = __privateMethod5(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
    ...
    __privateAdd6(this, _signTransaction, async ({ transaction, account, chain }) => {
      const popup = __privateMethod5(this, _SlushWallet_instances, getNewPopupChannel_fn).call(this);
    ...
    __privateAdd6(this, _connect, async (input) => {
      if (input == null ? void 0 : input.silent) {
        try {
          ...
          if (accounts.length) {
            __privateMethod5(this, _SlushWallet_instances, setAccounts_fn).call(this, accounts);
          }
        } catch (error) {
        }
      ...
      __privateMethod5(this, _SlushWallet_instances, setAccounts_fn).call(this, await getAccountsFromSession(response.session));
      return { accounts: this.accounts };
    });
    __privateAdd6(this, _disconnect, async () => {
      localStorage.removeItem(SLUSH_SESSION_KEY);
      __privateMethod5(this, _SlushWallet_instances, setAccounts_fn).call(this, []);
    });
    __privateSet7(this, _id2, metadata.id);
    __privateSet7(this, _accounts, []);
    __privateSet7(this, _events, mitt_default());
    __privateSet7(this, _origin, origin || DEFAULT_SLUSH_ORIGIN);
    __privateSet7(this, _name, name);
    __privateSet7(this, _walletName, metadata.walletName);
    __privateSet7(this, _icon, metadata.icon);
  }
  get name() {
    return __privateGet7(this, _walletName);
  }
  get id() {
    return __privateGet7(this, _id2);
  }
  get icon() {
    return __privateGet7(this, _icon);
  }
  get version() {
    return "1.0.0";
  }
...
setAccounts_fn = function(accounts) {
  __privateSet7(this, _accounts, accounts);
...
getNewPopupChannel_fn = function() {
  return new DappPostMessageChannel({
    appName: __privateGet7(this, _name),
    hostOrigin: __privateGet7(this, _origin)
  });
};
...
// node_modules/@mysten/dapp-kit/node_modules/@mysten/sui/dist/esm/utils/format.js
var ELLIPSIS = "…";
function formatAddress3(address) {
  if (address.length <= 6) {
    return address;
  }
...
function encodeStr3(data, encoding) {
  switch (encoding) {
    case "base58":
      return toBase58(data);
    case "base64":
...
var _BcsType5 = class _BcsType6 {
  constructor(options) {
    __privateAdd7(this, _write3);
    __privateAdd7(this, _serialize3);
    this.name = options.name;
    this.read = options.read;
    this.serializedSize = options.serializedSize ?? (() => null);
    __privateSet8(this, _write3, options.write);
    __privateSet8(this, _serialize3, options.serialize ?? ((value, options2) => {
      const writer = new BcsWriter3({
        initialSize: this.serializedSize(value) ?? void 0,
        ...options2
      });
      __privateGet8(this, _write3).call(this, value, writer);
      return writer.toBytes();
    }));
    this.validate = options.validate ?? (() => {
    });
  ...
  serialize(value, options) {
    this.validate(value);
    return new SerializedBcs3(this, __privateGet8(this, _serialize3).call(this, value, options));
  }
  parse(bytes) {
  ...
  transform({
    ...
    return new _BcsType6({
      name: name ?? this.name,
      read: (reader) => output ? output(this.read(reader)) : this.read(reader),
      write: (value, writer) => __privateGet8(this, _write3).call(this, input ? input(value) : value, writer),
      serializedSize: (value) => this.serializedSize(input ? input(value) : value),
      serialize: (value, options) => __privateGet8(this, _serialize3).call(this, input ? input(value) : value, options),
      validate: (value) => {
        validate3 == null ? void 0 : validate3(value);
        this.validate(input ? input(value) : value);
      }
...
var SerializedBcs3 = class {
  constructor(type, schema) {
    __privateAdd7(this, _schema3);
    __privateAdd7(this, _bytes3);
    __privateSet8(this, _schema3, type);
    __privateSet8(this, _bytes3, schema);
  }
  // Used to brand SerializedBcs so that they can be identified, even between multiple copies
  // of the @mysten/bcs package are installed
  ...
  toBytes() {
    return __privateGet8(this, _bytes3);
  }
  toHex() {
    return toHex(__privateGet8(this, _bytes3));
  }
  toBase64() {
    return toBase64(__privateGet8(this, _bytes3));
  }
  toBase58() {
    return toBase58(__privateGet8(this, _bytes3));
  }
  parse() {
    return __privateGet8(this, _schema3).parse(__privateGet8(this, _bytes3));
  }
};
...
var isValidNamedPackage3 = (name) => {
  const parts = name.split(NAME_SEPARATOR2);
  if (parts.length < 2 || parts.length > 3) return false;
  const [org, app, version] = parts;
...
var Owner3 = bcs3.enum("Owner", {
  ...
  Immutable: null,
  ConsensusV2: bcs3.struct("ConsensusV2", {
    authenticator: bcs3.enum("Authenticator", {
      SingleOwner: Address3
    }),
    ...
    return (0, import_jsx_runtime18.jsx)(
      MenuItemImpl,
      {
        ...
        onPointerUp: composeEventHandlers(props.onPointerUp, (event) => {
          var _a5;
          if (!isPointerDownRef.current) (_a5 = event.currentTarget) == null ? void 0 : _a5.click();
        }),
        onKeyDown: composeEventHandlers(props.onKeyDown, (event) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Collection2.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime18.jsx)(Presence2, { present: forceMount || context.open, children: (0, import_jsx_runtime18.jsx)(Collection2.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime18.jsx)(
      MenuContentImpl,
      {
        ...
        onOpenAutoFocus: (event) => {
          var _a5;
          if (rootContext.isUsingKeyboardRef.current) (_a5 = ref.current) == null ? void 0 : _a5.focus();
          event.preventDefault();
        },
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(
      Content22,
      {
        ...
        onCloseAutoFocus: composeEventHandlers(props.onCloseAutoFocus, (event) => {
          var _a5;
          if (!hasInteractedOutsideRef.current) (_a5 = context.triggerRef.current) == null ? void 0 : _a5.focus();
          hasInteractedOutsideRef.current = false;
          event.preventDefault();
        }),
...
var __privateMethod6 = (obj, member, method) => (__accessCheck8(obj, member, "access private method"), method);
...
var WebsocketClient = class {
  constructor(endpoint, options = {}) {
    __privateAdd8(this, _WebsocketClient_instances);
    __privateAdd8(this, _requestId, 0);
    __privateAdd8(this, _disconnects, 0);
    __privateAdd8(this, _webSocket, null);
    __privateAdd8(this, _connectionPromise, null);
    __privateAdd8(this, _subscriptions, /* @__PURE__ */ new Set());
    __privateAdd8(this, _pendingRequests, /* @__PURE__ */ new Map());
  ...
  async makeRequest(method, params, signal) {
    ...
    return new Promise((resolve, reject) => {
      __privateSet9(this, _requestId, __privateGet9(this, _requestId) + 1);
      __privateGet9(this, _pendingRequests).set(__privateGet9(this, _requestId), {
        resolve,
        reject,
        timeout: setTimeout(() => {
          __privateGet9(this, _pendingRequests).delete(__privateGet9(this, _requestId));
      ...
      webSocket.send(JSON.stringify({ jsonrpc: "2.0", id: __privateGet9(this, _requestId), method, params }));
    }).then(({ error, result }) => {
      if (error) {
  ...
  async subscribe(input) {
    ...
    __privateGet9(this, _subscriptions).add(subscription);
...
setupWebSocket_fn = function() {
  if (__privateGet9(this, _connectionPromise)) {
    return __privateGet9(this, _connectionPromise);
  }
  __privateSet9(this, _connectionPromise, new Promise((resolve) => {
    var _a5;
    (_a5 = __privateGet9(this, _webSocket)) == null ? void 0 : _a5.close();
    __privateSet9(this, _webSocket, new this.options.WebSocketConstructor(this.endpoint));
    __privateGet9(this, _webSocket).addEventListener("open", () => {
      __privateSet9(this, _disconnects, 0);
      resolve(__privateGet9(this, _webSocket));
    });
    __privateGet9(this, _webSocket).addEventListener("close", () => {
      __privateWrapper3(this, _disconnects)._++;
      if (__privateGet9(this, _disconnects) <= this.options.maxReconnects) {
        setTimeout(() => {
          __privateMethod6(this, _WebsocketClient_instances, reconnect_fn).call(this);
        }, this.options.reconnectTimeout);
      }
    });
    __privateGet9(this, _webSocket).addEventListener("message", ({ data }) => {
      let json;
      try {
      ...
      if ("id" in json && json.id != null && __privateGet9(this, _pendingRequests).has(json.id)) {
        const { resolve: resolve2, timeout } = __privateGet9(this, _pendingRequests).get(json.id);
        clearTimeout(timeout);
        resolve2(json);
      } else if ("params" in json) {
        const { params } = json;
        __privateGet9(this, _subscriptions).forEach((subscription) => {
...
reconnect_fn = async function() {
  var _a5;
  (_a5 = __privateGet9(this, _webSocket)) == null ? void 0 : _a5.close();
  __privateSet9(this, _connectionPromise, null);
  return Promise.allSettled(
    [...__privateGet9(this, _subscriptions)].map((subscription) => subscription.subscribe(this))
  );
};
...
var __privateMethod7 = (obj, member, method) => (__accessCheck9(obj, member, "access private method"), method);
var _requestId2;
var _options;
...
var SuiHTTPTransport = class {
  constructor(options) {
    __privateAdd9(this, _SuiHTTPTransport_instances);
    __privateAdd9(this, _requestId2, 0);
    __privateAdd9(this, _options);
    __privateAdd9(this, _websocketClient);
    __privateSet10(this, _options, options);
  }
  fetch(input, init) {
    const fetchFn = __privateGet10(this, _options).fetch ?? fetch;
    if (!fetchFn) {
      throw new Error(
  ...
  async request(input) {
    var _a5, _b4;
    __privateSet10(this, _requestId2, __privateGet10(this, _requestId2) + 1);
    const res = await this.fetch(((_a5 = __privateGet10(this, _options).rpc) == null ? void 0 : _a5.url) ?? __privateGet10(this, _options).url, {
      method: "POST",
      signal: input.signal,
      headers: {
        ...
        ...(_b4 = __privateGet10(this, _options).rpc) == null ? void 0 : _b4.headers
      },
      body: JSON.stringify({
        jsonrpc: "2.0",
        id: __privateGet10(this, _requestId2),
        method: input.method,
        params: input.params
      })
    });
...
getWebsocketClient_fn = function() {
  var _a5;
  if (!__privateGet10(this, _websocketClient)) {
    const WebSocketConstructor = __privateGet10(this, _options).WebSocketConstructor ?? WebSocket;
    if (!WebSocketConstructor) {
      throw new Error(
        "The current environment does not support WebSocket, you can provide a WebSocketConstructor in the options for SuiHTTPTransport."
      );
    }
    __privateSet10(this, _websocketClient, new WebsocketClient(
      ((_a5 = __privateGet10(this, _options).websocket) == null ? void 0 : _a5.url) ?? __privateGet10(this, _options).url,
      {
        WebSocketConstructor,
        ...__privateGet10(this, _options).websocket
      }
    ));
  }
  return __privateGet10(this, _websocketClient);
};
...
var _ClientCache = class _ClientCache2 {
  constructor({ prefix, cache } = {}) {
    __privateAdd10(this, _prefix);
    __privateAdd10(this, _cache4);
    __privateSet11(this, _prefix, prefix ?? []);
    __privateSet11(this, _cache4, cache ?? /* @__PURE__ */ new Map());
  }
  read(key, load) {
    const cacheKey = [__privateGet11(this, _prefix), ...key].join(":");
    if (__privateGet11(this, _cache4).has(cacheKey)) {
      return __privateGet11(this, _cache4).get(cacheKey);
    }
    const result = load();
    __privateGet11(this, _cache4).set(cacheKey, result);
    if (typeof result === "object" && result !== null && "then" in result) {
      return Promise.resolve(result).then((v) => {
        __privateGet11(this, _cache4).set(cacheKey, v);
        return v;
      }).catch((err) => {
        __privateGet11(this, _cache4).delete(cacheKey);
        throw err;
      });
    }
    return result;
  ...
  clear(prefix) {
    const prefixKey = [...__privateGet11(this, _prefix), ...prefix ?? []].join(":");
    if (!prefixKey) {
      __privateGet11(this, _cache4).clear();
      return;
    }
    for (const key of __privateGet11(this, _cache4).keys()) {
      if (key.startsWith(prefixKey)) {
        __privateGet11(this, _cache4).delete(key);
      }
    }
  }
  scope(prefix) {
    return new _ClientCache2({
      prefix: [...__privateGet11(this, _prefix), ...Array.isArray(prefix) ? prefix : [prefix]],
      cache: __privateGet11(this, _cache4)
    });
  }
};
...
// node_modules/@mysten/dapp-kit/node_modules/@mysten/sui/dist/esm/transactions/plugins/utils.js
function batch2(arr, size4) {
  const batches = [];
  for (let i = 0; i < arr.length; i += size4) {
    batches.push(arr.slice(i, i + size4));
  }
  return batches;
}
...
var TransactionDataBuilder2 = class _TransactionDataBuilder {
  ...
  static restore(data) {
    if (data.version === 2) {
      return new _TransactionDataBuilder(parse(TransactionData5, data));
    } else {
      return new _TransactionDataBuilder(parse(TransactionData5, transactionDataFromV12(data)));
    }
  }
  /**
   * Generate transaction digest.
...
var __privateMethod8 = (obj, member, method) => (__accessCheck11(obj, member, "access private method"), method);
...
var _Transaction3 = class _Transaction4 {
  constructor() {
    __privateAdd11(this, _Transaction_instances2);
    __privateAdd11(this, _serializationPlugins2);
    __privateAdd11(this, _buildPlugins2);
    __privateAdd11(this, _intentResolvers2, /* @__PURE__ */ new Map());
    __privateAdd11(this, _inputSection2, []);
    __privateAdd11(this, _commandSection2, []);
    __privateAdd11(this, _availableResults2, /* @__PURE__ */ new Set());
    __privateAdd11(this, _pendingPromises2, /* @__PURE__ */ new Set());
    __privateAdd11(this, _added2, /* @__PURE__ */ new Map());
    ...
    this.object = createObjectMethods2(
      (value) => {
        ...
        const inserted = __privateGet12(this, _data2).inputs.find((i) => id === getIdFromCallArg2(i));
        if (((_a5 = inserted == null ? void 0 : inserted.Object) == null ? void 0 : _a5.SharedObject) && typeof value === "object" && ((_b4 = value.Object) == null ? void 0 : _b4.SharedObject)) {
          inserted.Object.SharedObject.mutable = inserted.Object.SharedObject.mutable || value.Object.SharedObject.mutable;
        }
        return inserted ? { $kind: "Input", Input: __privateGet12(this, _data2).inputs.indexOf(inserted), type: "object" } : __privateMethod8(this, _Transaction_instances2, addInput_fn2).call(this, "object", typeof value === "string" ? {
          $kind: "UnresolvedObject",
    ...
    __privateSet12(this, _data2, new TransactionDataBuilder2());
    __privateSet12(this, _buildPlugins2, [...globalPlugins.buildPlugins.values()]);
    __privateSet12(this, _serializationPlugins2, [...globalPlugins.serializationPlugins.values()]);
  }
  /**
   * Converts from a serialize transaction kind (built with `build({ onlyTransactionKind: true })`) to a `Transaction` class.
   * Supports either a byte array, or base64-encoded bytes.
  ...
  static fromKind(serialized) {
    ...
    __privateSet12(tx, _data2, TransactionDataBuilder2.fromKindBytes(
      typeof serialized === "string" ? fromBase64(serialized) : serialized
    ));
    __privateSet12(tx, _inputSection2, __privateGet12(tx, _data2).inputs);
    __privateSet12(tx, _commandSection2, __privateGet12(tx, _data2).commands);
    return tx;
  }
  /**
   * Converts from a serialized transaction format to a `Transaction` class.
  ...
  static from(transaction) {
    ...
    if (isTransaction2(transaction)) {
      __privateSet12(newTransaction, _data2, new TransactionDataBuilder2(transaction.getData()));
    } else if (typeof transaction !== "string" || !transaction.startsWith("{")) {
      __privateSet12(newTransaction, _data2, TransactionDataBuilder2.fromBytes(
        typeof transaction === "string" ? fromBase64(transaction) : transaction
      ));
    } else {
      __privateSet12(newTransaction, _data2, TransactionDataBuilder2.restore(JSON.parse(transaction)));
    }
    __privateSet12(newTransaction, _inputSection2, __privateGet12(newTransaction, _data2).inputs);
    __privateSet12(newTransaction, _commandSection2, __privateGet12(newTransaction, _data2).commands);
    return newTransaction;
  }
  static registerGlobalSerializationPlugin(stepOrStep, step) {
  ...
  addSerializationPlugin(step) {
    __privateGet12(this, _serializationPlugins2).push(step);
  }
  addBuildPlugin(step) {
    __privateGet12(this, _buildPlugins2).push(step);
  }
  addIntentResolver(intent, resolver) {
    if (__privateGet12(this, _intentResolvers2).has(intent) && __privateGet12(this, _intentResolvers2).get(intent) !== resolver) {
      throw new Error(`Intent resolver for ${intent} already exists`);
    }
    __privateGet12(this, _intentResolvers2).set(intent, resolver);
  }
  setSender(sender) {
    __privateGet12(this, _data2).sender = sender;
  }
  /**
   * Sets the sender only if it has not already been set.
   * This is useful for sponsored transaction flows where the sender may not be the same as the signer address.
   */
  setSenderIfNotSet(sender) {
    if (!__privateGet12(this, _data2).sender) {
      __privateGet12(this, _data2).sender = sender;
    }
  }
  setExpiration(expiration) {
    __privateGet12(this, _data2).expiration = expiration ? parse(TransactionExpiration7, expiration) : null;
  }
  setGasPrice(price) {
    __privateGet12(this, _data2).gasConfig.price = String(price);
  }
  setGasBudget(budget) {
    __privateGet12(this, _data2).gasConfig.budget = String(budget);
  }
  setGasBudgetIfNotSet(budget) {
    if (__privateGet12(this, _data2).gasData.budget == null) {
      __privateGet12(this, _data2).gasConfig.budget = String(budget);
    }
  }
  setGasOwner(owner) {
    __privateGet12(this, _data2).gasConfig.owner = owner;
  }
  setGasPayment(payments) {
    __privateGet12(this, _data2).gasConfig.payment = payments.map((payment) => parse(ObjectRef3, payment));
  }
  /** @deprecated Use `getData()` instead. */
  get blockData() {
    return serializeV1TransactionData2(__privateGet12(this, _data2).snapshot());
  }
  /** Get a snapshot of the transaction data, in JSON form: */
  getData() {
    return __privateGet12(this, _data2).snapshot();
  }
  // Used to brand transaction classes so that they can be identified, even between multiple copies
  // of the builder.
    ...
    Object.defineProperty(this, "pure", {
      ...
      value: createPure2((value) => {
        if (isSerializedBcs3(value)) {
          return __privateMethod8(this, _Transaction_instances2, addInput_fn2).call(this, "pure", {
            $kind: "Pure",
            Pure: {
              bytes: value.toBase64()
            }
        ...
        return __privateMethod8(this, _Transaction_instances2, addInput_fn2).call(this, "pure", is(NormalizedCallArg3, value) ? parse(NormalizedCallArg3, value) : value instanceof Uint8Array ? Inputs2.Pure(value) : { $kind: "UnresolvedPure", UnresolvedPure: { value } });
      })
    });
    return this.pure;
  }
  ...
  add(command) {
    if (typeof command === "function") {
      if (__privateGet12(this, _added2).has(command)) {
        return __privateGet12(this, _added2).get(command);
      }
      const fork = __privateMethod8(this, _Transaction_instances2, fork_fn2).call(this);
      const result = command(fork);
      if (!(result && typeof result === "object" && "then" in result)) {
        __privateSet12(this, _availableResults2, __privateGet12(fork, _availableResults2));
        __privateGet12(this, _added2).set(command, result);
        return result;
      }
      const placeholder = __privateMethod8(this, _Transaction_instances2, addCommand_fn2).call(this, {
        $kind: "$Intent",
        $Intent: {
          name: "AsyncTransactionThunk",
          inputs: {},
      ...
      __privateGet12(this, _pendingPromises2).add(
        Promise.resolve(result).then((result2) => {
          placeholder.$Intent.data.result = result2;
        })
      );
      const txResult = createTransactionResult2(__privateGet12(this, _data2).commands.length - 1);
      __privateGet12(this, _added2).set(command, txResult);
      return txResult;
    } else {
      __privateMethod8(this, _Transaction_instances2, addCommand_fn2).call(this, command);
    }
    return createTransactionResult2(__privateGet12(this, _data2).commands.length - 1);
  }
  // Method shorthands:
  splitCoins(coin, amounts) {
    const command = Commands2.SplitCoins(
      typeof coin === "string" ? this.object(coin) : __privateMethod8(this, _Transaction_instances2, resolveArgument_fn2).call(this, coin),
      amounts.map(
        (amount) => typeof amount === "number" || typeof amount === "bigint" || typeof amount === "string" ? this.pure.u64(amount) : __privateMethod8(this, _Transaction_instances2, normalizeTransactionArgument_fn2).call(this, amount)
      )
    );
    __privateMethod8(this, _Transaction_instances2, addCommand_fn2).call(this, command);
    return createTransactionResult2(__privateGet12(this, _data2).commands.length - 1, amounts.length);
  }
  mergeCoins(destination, sources) {
    return this.add(
  ...
  moveCall({
    ...
    return this.add(
      Commands2.MoveCall({
        ...input,
        arguments: args == null ? void 0 : args.map((arg) => __privateMethod8(this, _Transaction_instances2, normalizeTransactionArgument_fn2).call(this, arg))
      })
    );
  }
  transferObjects(objects, address) {
    return this.add(
      Commands2.TransferObjects(
        objects.map((obj) => this.object(obj)),
        typeof address === "string" ? this.pure.address(address) : __privateMethod8(this, _Transaction_instances2, normalizeTransactionArgument_fn2).call(this, address)
      )
    );
  }
  makeMoveVec({
   ...
   * */
  serialize() {
    return JSON.stringify(serializeV1TransactionData2(__privateGet12(this, _data2).snapshot()));
  }
  async toJSON(options = {}) {
    await this.prepareForSerialization(options);
    return JSON.stringify(
      parse(SerializedTransactionDataV22, __privateGet12(this, _data2).snapshot()),
      (_key, value) => typeof value === "bigint" ? value.toString() : value,
      2
    );
  }
  ...
  async build(options = {}) {
    await this.prepareForSerialization(options);
    await __privateMethod8(this, _Transaction_instances2, prepareBuild_fn2).call(this, options);
    return __privateGet12(this, _data2).build({
      onlyTransactionKind: options.onlyTransactionKind
    });
  }
  /** Derive transaction digest */
  async getDigest(options = {}) {
    await __privateMethod8(this, _Transaction_instances2, prepareBuild_fn2).call(this, options);
    return __privateGet12(this, _data2).getDigest();
  }
  async prepareForSerialization(options) {
    var _a5;
    await __privateMethod8(this, _Transaction_instances2, waitForPendingTasks_fn2).call(this);
    __privateMethod8(this, _Transaction_instances2, sortCommandsAndInputs_fn2).call(this);
    const intents = /* @__PURE__ */ new Set();
    for (const command of __privateGet12(this, _data2).commands) {
      if (command.$Intent) {
        intents.add(command.$Intent.name);
      }
    }
    const steps = [...__privateGet12(this, _serializationPlugins2)];
    for (const intent of intents) {
      if ((_a5 = options.supportedIntents) == null ? void 0 : _a5.includes(intent)) {
        continue;
      }
      if (!__privateGet12(this, _intentResolvers2).has(intent)) {
        throw new Error(`Missing intent resolver for ${intent}`);
      }
      steps.push(__privateGet12(this, _intentResolvers2).get(intent));
    }
    await __privateMethod8(this, _Transaction_instances2, runPlugins_fn2).call(this, steps, options);
  }
};
...
fork_fn2 = function() {
  ...
  __privateSet12(fork, _data2, __privateGet12(this, _data2));
  __privateSet12(fork, _serializationPlugins2, __privateGet12(this, _serializationPlugins2));
  __privateSet12(fork, _buildPlugins2, __privateGet12(this, _buildPlugins2));
  __privateSet12(fork, _intentResolvers2, __privateGet12(this, _intentResolvers2));
  __privateSet12(fork, _pendingPromises2, __privateGet12(this, _pendingPromises2));
  __privateSet12(fork, _availableResults2, new Set(__privateGet12(this, _availableResults2)));
  __privateSet12(fork, _added2, __privateGet12(this, _added2));
  __privateGet12(this, _inputSection2).push(__privateGet12(fork, _inputSection2));
  __privateGet12(this, _commandSection2).push(__privateGet12(fork, _commandSection2));
  return fork;
};
addCommand_fn2 = function(command) {
  const resultIndex = __privateGet12(this, _data2).commands.length;
  __privateGet12(this, _commandSection2).push(command);
  __privateGet12(this, _availableResults2).add(resultIndex);
  __privateGet12(this, _data2).commands.push(command);
  __privateGet12(this, _data2).mapCommandArguments(resultIndex, (arg) => {
    if (arg.$kind === "Result" && !__privateGet12(this, _availableResults2).has(arg.Result)) {
      throw new Error(
        `Result { Result: ${arg.Result} } is not available to use the current transaction`
      );
    }
    if (arg.$kind === "NestedResult" && !__privateGet12(this, _availableResults2).has(arg.NestedResult[0])) {
      throw new Error(
        `Result { NestedResult: [${arg.NestedResult[0]}, ${arg.NestedResult[1]}] } is not available to use the current transaction`
      );
    }
    if (arg.$kind === "Input" && arg.Input >= __privateGet12(this, _data2).inputs.length) {
      throw new Error(
        `Input { Input: ${arg.Input} } references an input that does not exist in the current transaction`
      );
    }
...
addInput_fn2 = function(type, input) {
  __privateGet12(this, _inputSection2).push(input);
  return __privateGet12(this, _data2).addInput(type, input);
};
normalizeTransactionArgument_fn2 = function(arg) {
  if (isSerializedBcs3(arg)) {
    return this.pure(arg);
  }
  return __privateMethod8(this, _Transaction_instances2, resolveArgument_fn2).call(this, arg);
};
resolveArgument_fn2 = function(arg) {
  if (typeof arg === "function") {
    const resolved = this.add(arg);
    if (typeof resolved === "function") {
      return __privateMethod8(this, _Transaction_instances2, resolveArgument_fn2).call(this, resolved);
    }
...
prepareBuild_fn2 = async function(options) {
  if (!options.onlyTransactionKind && !__privateGet12(this, _data2).sender) {
    throw new Error("Missing transaction sender");
  }
  await __privateMethod8(this, _Transaction_instances2, runPlugins_fn2).call(this, [...__privateGet12(this, _buildPlugins2), resolveTransactionPlugin2], options);
};
runPlugins_fn2 = async function(plugins, options) {
  const createNext = (i) => {
    ...
    return async () => {
      ...
      let calledNext = false;
      let nextResolved = false;
      await plugin(__privateGet12(this, _data2), options, async () => {
        if (calledNext) {
          throw new Error(`next() was call multiple times in TransactionPlugin ${i}`);
        }
        calledNext = true;
  ...
  await createNext(0)();
  __privateSet12(this, _inputSection2, __privateGet12(this, _data2).inputs);
  __privateSet12(this, _commandSection2, __privateGet12(this, _data2).commands);
};
waitForPendingTasks_fn2 = async function() {
  while (__privateGet12(this, _pendingPromises2).size > 0) {
    const newPromise = Promise.all(__privateGet12(this, _pendingPromises2));
    __privateGet12(this, _pendingPromises2).clear();
    __privateGet12(this, _pendingPromises2).add(newPromise);
    await newPromise;
    __privateGet12(this, _pendingPromises2).delete(newPromise);
  }
};
sortCommandsAndInputs_fn2 = function() {
  const unorderedCommands = __privateGet12(this, _data2).commands;
  const unorderedInputs = __privateGet12(this, _data2).inputs;
  const orderedCommands = __privateGet12(this, _commandSection2).flat(Infinity);
  const orderedInputs = __privateGet12(this, _inputSection2).flat(Infinity);
  if (orderedCommands.length !== unorderedCommands.length) {
    throw new Error("Unexpected number of commands found in transaction data");
  }
  if (orderedInputs.length !== unorderedInputs.length) {
  ...
  __privateGet12(this, _data2).commands = filteredCommands;
  __privateGet12(this, _data2).inputs = orderedInputs;
  __privateSet12(this, _commandSection2, filteredCommands);
  __privateSet12(this, _inputSection2, orderedInputs);
  function getOriginalIndex(index2) {
    var _a5;
    const command = unorderedCommands[index2];
    if (((_a5 = command.$Intent) == null ? void 0 : _a5.name) === "AsyncTransactionThunk") {
  ...
  __privateGet12(this, _data2).mapArguments((arg) => {
    if (arg.$kind === "Input") {
      const updated = orderedInputs.indexOf(unorderedInputs[arg.Input]);
      if (updated === -1) {
        throw new Error("Input has not been resolved");
    ...
    return {
      dynamicField: {
        ...
        value: {
          ...
          bcs: fieldObject.content.slice(SUI_ADDRESS_LENGTH3 + options.name.bcs.length)
        }
      }
    };
  }
...
function getPureBcsSchema2(typeSignature) {
  ...
  if ("datatype" in typeSignature) {
    ...
    if (pkg === normalizeSuiAddress3(SUI_FRAMEWORK_ADDRESS3) && typeSignature.datatype.module === OBJECT_MODULE_NAME && typeSignature.datatype.type === ID_STRUCT_NAME) {
      return suiBcs3.Address;
    }
  }
  return null;
...
var __privateMethod9 = (obj, member, method) => (__accessCheck12(obj, member, "access private method"), method);
var __privateWrapper4 = (obj, member, setter, getter) => ({
  set _(value) {
    __privateSet13(obj, member, value, setter);
  },
  get _() {
    return __privateGet13(obj, member, getter);
  }
});
var _signer4;
var _client4;
...
getUsedObjects_fn2 = async function(transaction) {
  ...
  await transaction.prepareForSerialization({ client: __privateGet13(this, _client4) });
  return usedObjects;
};
execute_fn2 = async function(transaction, usedObjects, options, additionalSignatures = []) {
  ...
  let gasCoin;
  try {
    transaction.setSenderIfNotSet(__privateGet13(this, _signer4).toSuiAddress());
    await __privateGet13(this, _buildQueue2).runTask(async () => {
      const data = transaction.getData();
      if (!data.gasData.price) {
        transaction.setGasPrice(await __privateMethod9(this, _ParallelTransactionExecutor_instances2, getGasPrice_fn2).call(this));
      }
      transaction.setGasBudgetIfNotSet(__privateGet13(this, _defaultGasBudget4));
      await __privateMethod9(this, _ParallelTransactionExecutor_instances2, updateCache_fn2).call(this);
      gasCoin = await __privateMethod9(this, _ParallelTransactionExecutor_instances2, getGasCoin_fn2).call(this);
      ...
      await __privateGet13(this, _cache7).buildTransaction({ transaction, onlyTransactionKind: true });
    });
    const bytes = await transaction.build({ client: __privateGet13(this, _client4) });
    const { signature } = await __privateGet13(this, _signer4).signTransaction(bytes);
    const results = await __privateGet13(this, _cache7).executeTransaction({
      transaction: bytes,
      signature: [signature, ...additionalSignatures],
      options: {
        ...options,
    ...
    const gasUsed = (_a5 = effects.V2) == null ? void 0 : _a5.gasUsed;
    if (gasCoin && gasUsed && gasResult.owner === __privateGet13(this, _signer4).toSuiAddress()) {
      const totalUsed = BigInt(gasUsed.computationCost) + BigInt(gasUsed.storageCost) + BigInt(gasUsed.storageCost) - BigInt(gasUsed.storageRebate);
      let usesGasCoin = false;
      ...
      if (!usesGasCoin && gasCoin.balance >= __privateGet13(this, _minimumCoinBalance2)) {
        __privateGet13(this, _coinPool2).push({
          id: gasResult.ref.objectId,
          version: gasResult.ref.version,
          digest: gasResult.ref.digest,
          balance: gasCoin.balance - totalUsed
        ...
        if (!__privateGet13(this, _sourceCoins2)) {
          __privateSet13(this, _sourceCoins2, /* @__PURE__ */ new Map());
        }
        __privateGet13(this, _sourceCoins2).set(gasResult.ref.objectId, gasResult.ref);
      }
    }
    __privateSet13(this, _lastDigest4, results.digest);
    return {
      digest: results.digest,
      effects: toBase64(effectsBytes),
      data: results
    ...
    if (gasCoin) {
      ...
      __privateGet13(this, _sourceCoins2).set(gasCoin.id, null);
    }
    await __privateMethod9(this, _ParallelTransactionExecutor_instances2, updateCache_fn2).call(this, async () => {
      await Promise.all([
        __privateGet13(this, _cache7).cache.deleteObjects([...usedObjects]),
        __privateMethod9(this, _ParallelTransactionExecutor_instances2, waitForLastDigest_fn2).call(this)
      ]);
    });
    throw error;
  } finally {
    usedObjects.forEach((objectId) => {
      const queue = __privateGet13(this, _objectIdQueues2).get(objectId);
      if (queue && queue.length > 0) {
        queue.shift()();
      } else if (queue) {
        __privateGet13(this, _objectIdQueues2).delete(objectId);
      }
    });
    __privateWrapper4(this, _pendingTransactions2)._--;
  }
...
updateCache_fn2 = async function(fn) {
  if (__privateGet13(this, _cacheLock2)) {
    await __privateGet13(this, _cacheLock2);
  }
  __privateSet13(this, _cacheLock2, (fn == null ? void 0 : fn().then(
    () => {
      __privateSet13(this, _cacheLock2, null);
    },
    () => {
    }
  )) ?? null);
...
waitForLastDigest_fn2 = async function() {
  const digest = __privateGet13(this, _lastDigest4);
  if (digest) {
    __privateSet13(this, _lastDigest4, null);
    await __privateGet13(this, _client4).waitForTransaction({ digest });
  }
};
getGasCoin_fn2 = async function() {
  if (__privateGet13(this, _coinPool2).length === 0 && __privateGet13(this, _pendingTransactions2) <= __privateGet13(this, _maxPoolSize2)) {
    await __privateMethod9(this, _ParallelTransactionExecutor_instances2, refillCoinPool_fn2).call(this);
  }
  if (__privateGet13(this, _coinPool2).length === 0) {
    throw new Error("No coins available");
  }
  const coin = __privateGet13(this, _coinPool2).shift();
  return coin;
};
getGasPrice_fn2 = async function() {
  const remaining = __privateGet13(this, _gasPrice2) ? __privateGet13(this, _gasPrice2).expiration - __privateGet13(this, _epochBoundaryWindow2) - Date.now() : 0;
  if (remaining > 0) {
    return __privateGet13(this, _gasPrice2).price;
  }
  if (__privateGet13(this, _gasPrice2)) {
    const timeToNextEpoch = Math.max(
      __privateGet13(this, _gasPrice2).expiration + __privateGet13(this, _epochBoundaryWindow2) - Date.now(),
      1e3
    );
    await new Promise((resolve) => setTimeout(resolve, timeToNextEpoch));
  }
  const state = await __privateGet13(this, _client4).getLatestSuiSystemState();
  __privateSet13(this, _gasPrice2, {
    price: BigInt(state.referenceGasPrice),
    expiration: Number.parseInt(state.epochStartTimestampMs, 10) + Number.parseInt(state.epochDurationMs, 10)
  });
  return __privateMethod9(this, _ParallelTransactionExecutor_instances2, getGasPrice_fn2).call(this);
};
refillCoinPool_fn2 = async function() {
  var _a5;
  const batchSize = Math.min(
    __privateGet13(this, _coinBatchSize2),
    __privateGet13(this, _maxPoolSize2) - (__privateGet13(this, _coinPool2).length + __privateGet13(this, _pendingTransactions2)) + 1
  );
  if (batchSize === 0) {
    return;
  }
  const txb = new Transaction2();
  const address = __privateGet13(this, _signer4).toSuiAddress();
  txb.setSender(address);
  if (__privateGet13(this, _sourceCoins2)) {
    const refs = [];
    const ids = [];
    for (const [id, ref] of __privateGet13(this, _sourceCoins2)) {
      if (ref) {
        refs.push(ref);
      } else {
        ids.push(id);
    ...
    if (ids.length > 0) {
      const coins = await __privateGet13(this, _client4).multiGetObjects({
        ids
      });
      refs.push(
        ...coins.filter((coin) => coin.data !== null).map(({ data }) => ({
  ...
  const amounts = new Array(batchSize).fill(__privateGet13(this, _initialCoinBalance2));
  const results = txb.splitCoins(txb.gas, amounts);
  const coinResults = [];
  for (let i = 0; i < amounts.length; i++) {
    coinResults.push(results[i]);
  ...
  txb.transferObjects(coinResults, address);
  await this.waitForLastTransaction();
  const result = await __privateGet13(this, _client4).signAndExecuteTransaction({
    transaction: txb,
    signer: __privateGet13(this, _signer4),
    options: {
      showRawEffects: true
    }
  });
  ...
  (_a5 = effects.V2) == null ? void 0 : _a5.changedObjects.forEach(([id, { outputState }], i) => {
    ...
    __privateGet13(this, _coinPool2).push({
      ...
      version: effects.V2.lamportVersion,
      digest: outputState.ObjectWrite[0],
      balance: BigInt(__privateGet13(this, _initialCoinBalance2))
    });
  });
  if (!__privateGet13(this, _sourceCoins2)) {
    __privateSet13(this, _sourceCoins2, /* @__PURE__ */ new Map());
  ...
  __privateGet13(this, _sourceCoins2).set(gasObject.objectId, gasObject);
  await __privateGet13(this, _client4).waitForTransaction({ digest: result.digest });
};
  ...
  const changedObjects = effects.changedObjects.map(
    ([id, change]) => {
      ...
      return {
        ...
        inputVersion: ((_a5 = change.inputState.Exist) == null ? void 0 : _a5[0][0]) ?? null,
...
var MAX_GAS = 5e10;
function resolveTransactionPlugin3(client) {
  ...
  if (!transactionData.gasConfig.payment) {
    ...
    const paymentCoins = coins.data.filter((coin) => {
      const matchingInput = transactionData.inputs.find((input) => {
        var _a5;
        if ((_a5 = input.Object) == null ? void 0 : _a5.ImmOrOwnedObject) {
...
async function normalizeInputs(transactionData, client) {
  ...
  commands.forEach((command) => {
    ...
    params.forEach((param, i) => {
      ...
      const inputValue = ((_a5 = input.UnresolvedPure) == null ? void 0 : _a5.value) ?? ((_b4 = input.UnresolvedObject) == null ? void 0 : _b4.objectId);
...
var JSONRpcTransport = class extends Experimental_CoreClient {
  constructor(jsonRpcClient) {
    ...
    __privateAdd12(this, _jsonRpcClient);
    __privateSet14(this, _jsonRpcClient, jsonRpcClient);
  }
  async getObjects(options) {
    const batches = batch2(options.objectIds, 50);
    const results = [];
    for (const batch22 of batches) {
      const objects = await __privateGet14(this, _jsonRpcClient).multiGetObjects({
        ids: batch22,
        options: {
          showOwner: true,
          showType: true,
      ...
      for (const [idx, object2] of objects.entries()) {
        if (object2.error) {
          results.push(ObjectError.fromResponse(object2.error, batch22[idx]));
        } else {
  ...
  async getOwnedObjects(options) {
    const objects = await __privateGet14(this, _jsonRpcClient).getOwnedObjects({
  ...
  async getCoins(options) {
    const coins = await __privateGet14(this, _jsonRpcClient).getCoins({
      owner: options.address,
  ...
  async getBalance(options) {
    const balance = await __privateGet14(this, _jsonRpcClient).getBalance({
      owner: options.address,
      coinType: options.coinType,
      signal: options.signal
    });
  ...
  async getAllBalances(options) {
    const balances = await __privateGet14(this, _jsonRpcClient).getAllBalances({
      owner: options.address,
      signal: options.signal
    });
    return {
  ...
  async getTransaction(options) {
    const transaction = await __privateGet14(this, _jsonRpcClient).getTransactionBlock({
  ...
  async executeTransaction(options) {
    const transaction = await __privateGet14(this, _jsonRpcClient).executeTransactionBlock({
  ...
  async dryRunTransaction(options) {
    ...
    const result = await __privateGet14(this, _jsonRpcClient).dryRunTransactionBlock({
      transactionBlock: options.transaction,
      signal: options.signal
    });
  ...
  async getReferenceGasPrice(options) {
    const referenceGasPrice = await __privateGet14(this, _jsonRpcClient).getReferenceGasPrice({
  ...
  async getDynamicFields(options) {
    const dynamicFields = await __privateGet14(this, _jsonRpcClient).getDynamicFields({
  ...
  async verifyZkLoginSignature(options) {
    const result = await __privateGet14(this, _jsonRpcClient).verifyZkLoginSignature({
      bytes: options.bytes,
  ...
  resolveTransactionPlugin() {
    return resolveTransactionPlugin3(__privateGet14(this, _jsonRpcClient));
  }
};
...
function parseObject(object2) {
  ...
  return {
    ...
    type: object2.type,
    content: ((_a5 = object2.bcs) == null ? void 0 : _a5.dataType) === "moveObject" ? fromBase64(object2.bcs.bcsBytes) : new Uint8Array(),
...
function parseTransaction(transaction) {
  ...
  const objectTypes = {};
  (_a5 = transaction.objectChanges) == null ? void 0 : _a5.forEach((change) => {
    if (change.type !== "published") {
      objectTypes[change.objectId] = change.objectType;
    }
  });
  const bytes = suiBcs3.TransactionData.serialize(parsedTx.intentMessage.value).toBytes();
  const data = TransactionDataBuilder2.restore({
    version: 2,
...
function parseTransactionEffectsJson({
    ...
    switch (change.type) {
      ...
      case "deleted":
        changedObjects.push({
          ...
          inputState: "Exists",
          inputVersion: change.version,
          inputDigest: ((_b4 = (_a6 = effects.deleted) == null ? void 0 : _a6.find((d) => d.objectId === change.objectId)) == null ? void 0 : _b4.digest) ?? null,
          inputOwner: null,
  ...
  return {
    ...
    effects: {
      ...
      transactionDigest: effects.transactionDigest,
      gasObject: {
        id: (_a5 = effects.gasObject) == null ? void 0 : _a5.reference.objectId,
        inputState: "Exists",
        inputVersion: null,
        inputDigest: null,
        inputOwner: null,
...
var SuiClient = class extends Experimental_BaseClient {
  ...
  async devInspectTransactionBlock(input) {
    ...
    (_a5 = input.signal) == null ? void 0 : _a5.throwIfAborted();
    return await this.transport.request({
  ...
  async resolveNameServiceNames({
    ...
    return {
      hasNextPage,
      nextCursor,
      data: data.map((name) => normalizeSuiNSName3(name, format))
    };
  }
...
graphqlQuery_fn = async function(options, getData) {
  const { data, errors } = await __privateGet15(this, _graphqlClient).query(options);
...
toLegacyAddress_fn = function() {
  const legacyBytes = normalizeZkLoginPublicKeyBytes(__privateGet16(this, _data3), true);
...
// node_modules/@mysten/dapp-kit/node_modules/@mysten/sui/dist/esm/cryptography/signature.js
...
// node_modules/@mysten/dapp-kit/node_modules/@mysten/sui/dist/esm/cryptography/keypair.js
...
var Signer = class {
  ...
  async signPersonalMessage(bytes) {
    const { signature } = await this.signWithIntent(
      bcs3.vector(bcs3.u8()).serialize(bytes).toBytes(),
      "PersonalMessage"
    );
    return {
      bytes: toBase64(bytes),
...
// node_modules/@mysten/dapp-kit/node_modules/@mysten/sui/dist/esm/cryptography/mnemonics.js
...
// node_modules/@mysten/dapp-kit/node_modules/@mysten/sui/dist/esm/keypairs/ed25519/keypair.js
...
var Ed25519Keypair = class _Ed25519Keypair extends Keypair {
  ...
  static fromSecretKey(secretKey, options) {
    ...
    if (!options || !options.skipValidation) {
      ...
      const signData = encoder2.encode("sui validation");
...
var oldImpl = (config, baseOptions) => (set, get2, api) => {
  ...
  const hydrate = () => {
    ...
    const postRehydrationCallback = ((_a5 = options.onRehydrateStorage) == null ? void 0 : _a5.call(options, get2())) || void 0;
...
var newImpl = (config, baseOptions) => (set, get2, api) => {
  ...
  const hydrate = () => {
    ...
    const postRehydrationCallback = ((_b4 = options.onRehydrateStorage) == null ? void 0 : _b4.call(options, (_a5 = get2()) != null ? _a5 : configResult)) || void 0;
...
var lexicalAnalysis = function lexicalAnalysis2(str, index2) {
  ...
  for (; index2 < str.length; index2 += 1) {
    ...
    if (code === 9 || code === 32 || code === 10) {
      ...
      var _a5 = __read(result, 2), lastIndex = _a5[0], value = _a5[1];
      tokens.push({
        type: "<string-token>",
        value
      });
...
var consumeString = function consumeString2(str, index2) {
  ...
  for (var i = index2 + 1; i < str.length; i += 1) {
    ...
    if (code === firstCode) {
      ...
      var _a5 = __read(result, 2), lastIndex = _a5[0], charCode = _a5[1];
...
var consumeNumeric = function consumeNumeric2(str, index2) {
  ...
  var _a5 = __read(numberResult, 3), numberEndIndex = _a5[0], numberValue = _a5[1], numberFlag = _a5[2];
...
var consumeIdentUnsafe = function consumeIdentUnsafe2(str, index2) {
  ...
  for (var code = str.charCodeAt(index2); index2 < str.length; code = str.charCodeAt(++index2)) {
    if (code === 45 || code === 95 || code >= 65 && code <= 90 || code >= 97 && code <= 122 || code >= 128 || code >= 48 && code <= 57) {
      ...
      var result = consumeEscape(str, index2);
      if (result !== null) {
        var _a5 = __read(result, 2), lastIndex = _a5[0], code_4 = _a5[1];
...
var consumeIdent = function consumeIdent2(str, index2) {
  ...
  for (var code = str.charCodeAt(index2); index2 < str.length; code = str.charCodeAt(++index2)) {
    if (code === 45 || code === 95 || code >= 65 && code <= 90 || code >= 97 && code <= 122 || code >= 128 || code >= 48 && code <= 57) {
      ...
      var result = consumeEscape(str, index2);
      if (result !== null) {
        var _a5 = __read(result, 2), lastIndex = _a5[0], code_5 = _a5[1];
...
var syntacticAnalysis = function syntacticAnalysis2(tokenList) {
  ...
  if (mediaQueries.length === 1 && mediaQueries[0].length === 0) {
    ...
    try {
      ...
      try {
        if (mediaQueryTokens_1_1 && !mediaQueryTokens_1_1.done && (_a5 = mediaQueryTokens_1["return"])) _a5.call(mediaQueryTokens_1);
      } finally {
...
var tokenizeRange = function tokenizeRange2(tokens) {
  ...
  if (tokens[2].type === "<delim-token>") {
    ...
    var tokenIndexAfterFirstOp = 2 + ((_b4 = (_a5 = range[hasLeft ? "leftOp" : "rightOp"]) === null || _a5 === void 0 ? void 0 : _a5.length) !== null && _b4 !== void 0 ? _b4 : 0);
...
var _LRUCache = class _LRUCache {
  ...
  static unsafeExposeInternals(c) {
    return {
      ...
      backgroundFetch: (k, index2, options, context) => {
        var _a5;
        return __privateMethod(_a5 = c, _LRUCache_instances, backgroundFetch_fn).call(_a5, k, index2, options, context);
      },
      moveToTail: (index2) => {
        var _a5;
        return __privateMethod(_a5 = c, _LRUCache_instances, moveToTail_fn).call(_a5, index2);
      },
      indexes: (options) => {
        var _a5;
      ...
      isStale: (index2) => {
        var _a5;
        return __privateGet(_a5 = c, _isStale).call(_a5, index2);
      }
    };
  }
  ...
  *rvalues() {
   ...
   */
  [(_b3 = Symbol.iterator, _a4 = Symbol.toStringTag, _b3)]() {
    return this.entries();
  }
  /**
...
var __privateAdd13 = (obj, member, value) => member.has(obj) ? __typeError16("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value);
...
function ConnectionStatus({
  ...
  return (0, import_jsx_runtime27.jsxs)("div", { className: container2, children: [
    selectedWallet.icon && (0, import_jsx_runtime27.jsx)(
      "img",
      {
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime32.jsx)("li", { className: container7, children: (0, import_jsx_runtime32.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime32.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
        (0, import_jsx_runtime32.jsx)(Heading, { size: "md", truncate: true, asChild: true, children: (0, import_jsx_runtime32.jsx)("div", { children: name }) })
      ]
    }
  ) });
}
function WalletList({
  ...
  return (0, import_jsx_runtime33.jsx)("ul", { className: container6, children: wallets.length > 0 ? wallets.map((wallet) => (0, import_jsx_runtime33.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
...
function SuiClientProvider(props) {
  ...
  const [selectedNetwork, setSelectedNetwork] = (0, import_react18.useState)(
...
function useSuiClientSuspenseQuery(...args) {
  ...
  const suiContext = useSuiClientContext();
  const query = (0, import_react16.useMemo)(() => {
...
function useDisconnectWallet({
  ...
  return useMutation({
    ...
    mutationFn: async () => {
      ...
      try {
        await ((_a5 = currentWallet.features["standard:disconnect"]) == null ? void 0 : _a5.disconnect());
      } catch (error) {
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime38.jsxs)(Root23, { modal: false, children: [
    (0, import_jsx_runtime38.jsx)(StyleMarker, { children: (0, import_jsx_runtime38.jsx)(Trigger2, { asChild: true, children: (0, import_jsx_runtime38.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
      (0, import_jsx_runtime38.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? domain ?? formatAddress3(currentAccount.address) }),
...
function AccountDropdownMenuItem({
  ...
  return (0, import_jsx_runtime38.jsxs)(
    Item22,
    {
      ...
      children: [
        (0, import_jsx_runtime38.jsx)(Text, { mono: true, children: account.label ?? domain ?? formatAddress3(account.address) }),
...
function useAutoConnectWallet() {
  ...
  const [clientOnly, setClientOnly] = (0, import_react20.useState)(false);
...
function registerUnsafeBurnerWallet(suiClient) {
  ...
  class UnsafeBurnerWallet {
    constructor() {
      __privateAdd13(this, _on2, () => {
        return () => {
        };
      });
      __privateAdd13(this, _connect2, async () => {
        return { accounts: this.accounts };
      });
      __privateAdd13(this, _signPersonalMessage2, async (messageInput) => {
        const { bytes, signature } = await keypair.signPersonalMessage(messageInput.message);
        return { bytes, signature };
      });
      __privateAdd13(this, _signTransactionBlock2, async (transactionInput) => {
      ...
      __privateAdd13(this, _signTransaction2, async (transactionInput) => {
        var _a5;
        const { bytes, signature } = await Transaction2.from(
          await transactionInput.transaction.toJSON()
        ).sign({
          client: suiClient,
          signer: keypair
        });
        (_a5 = transactionInput.signal) == null ? void 0 : _a5.throwIfAborted();
        return {
          bytes,
          signature
        };
      });
      __privateAdd13(this, _signAndExecuteTransactionBlock, async (transactionInput) => {
        const { bytes, signature } = await transactionInput.transactionBlock.sign({
          client: suiClient,
          signer: keypair
        });
      ...
      __privateAdd13(this, _signAndExecuteTransaction2, async (transactionInput) => {
        var _a5;
        const { bytes, signature } = await Transaction2.from(
          await transactionInput.transaction.toJSON()
        ).sign({
    ...
    get features() {
      return {
        "standard:connect": {
          version: "1.0.0",
          connect: __privateGet17(this, _connect2)
        },
        "standard:events": {
          version: "1.0.0",
          on: __privateGet17(this, _on2)
        },
        "sui:signPersonalMessage": {
          version: "1.1.0",
          signPersonalMessage: __privateGet17(this, _signPersonalMessage2)
        },
        "sui:signTransactionBlock": {
          version: "1.0.0",
          signTransactionBlock: __privateGet17(this, _signTransactionBlock2)
        },
        "sui:signAndExecuteTransactionBlock": {
          version: "1.0.0",
          signAndExecuteTransactionBlock: __privateGet17(this, _signAndExecuteTransactionBlock)
        },
        "sui:signTransaction": {
          version: "2.0.0",
          signTransaction: __privateGet17(this, _signTransaction2)
        },
        "sui:signAndExecuteTransaction": {
          version: "2.0.0",
          signAndExecuteTransaction: __privateGet17(this, _signAndExecuteTransaction2)
        }
      };
    }
  }
...
function WalletProvider({
  ...
  const storeRef = (0, import_react19.useRef)(
    createWalletStore({
...
function useSignAndExecuteTransaction({
  ...
  return useMutation({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      let effects;
      if ("effects" in result && ((_a5 = result.effects) == null ? void 0 : _a5.bcs)) {
